    ...
    <div class="flex">
      ...
      <aside class="w-80">
        <div class="p-6">
          ...
          <div
            class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-6 text-white mb-6 shadow"
          >
          ...
          <div class="space-y-4 mb-6">
            <div class="flex justify-between items-center">
              ...
              <span
                class="text-sm text-green-600 bg-green-100 p-2 rounded-lg font-bold"
                >Open</span
              >
            </div>
