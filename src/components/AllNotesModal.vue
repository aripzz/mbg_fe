<template>
  <div v-if="isOpen" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
    <div class="relative w-full max-w-3xl mx-4 bg-white rounded-lg shadow-lg dark:bg-gray-800">
      <!-- Header -->
      ...
      <div class="p-6 max-h-[70vh] overflow-y-auto">
            ...
            <div class="flex items-start space-x-4">
              ...
              <div class="flex-1 min-w-0">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-300 mb-3 leading-relaxed">
                  {{ note.catatan_terakhir || "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua." }}
                </p>
                
                <div class="flex items-center justify-start">
                  <div class="text-xs text-gray-400 dark:text-gray-500">
                    <i class="fas fa-clock mr-1"></i>
                    {{ note.updated_at || getRandomDate() }}
                  </div>
        ...
        <!-- Empty State -->
        <div v-if="!notes || notes.length === 0" class="text-center py-8">
          <div class="text-gray-500 dark:text-gray-400">
            <i class="fas fa-sticky-note text-4xl mb-4"></i>
            <p class="text-lg font-medium mb-2">Tidak ada catatan</p>
            <p class="text-sm">Belum ada catatan yang tersedia untuk ditampilkan</p>
          </div>
        </div>
      </div>
    </div>
